...
<html>
    ...
    <body class="main">
        ...
        <div class="ticket">
            ...
            <form class="frm_veiculo" id="cadC" name="cadVeiculo" action="" method="post">
                <div>
                    ...
                    <p><label for="Chora">Data:</label>&nbsp;<?php include './funcoes/dataHora.php';?></p>
                    <p><label>Hora:</label>&nbsp;<?php echo date("H:i:s "); ?></p>
                    <p><label>Total a pagar:</label><input type="text" name="totalHora" readonly/></p>
